...
def main():
    ...
    parser.add_argument('--class_list', default='/home/junyi/dataset/Food-101N_release/meta/classes.txt',
                        help='List of class name')
    parser.add_argument('--data_path', default='/home/junyi/dataset/Food-101N_release/meta/verified_val.tsv',
                        help='Path to datasets')
    parser.add_argument('--output_dir', default='/home/junyi/dataset/Food-101N_release/Food-101N/',
                        help='Output dir')
